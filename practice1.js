...
// let ar=[1,2,3,4,5];
//  function doublearry(arr,num){
//     let emprty=[];
//     for (let item of arr){
//         emprty.push(item*num);
//     }
//     return emprty;
//  }
...
// const str="this is"
//  let result= str.split("").filter((item)=> item !==" ").length
//  console.log(result);
...
// finding total count value of arry 
//  const toatlarr=(arr1)=>{
//   let result=0;
...
// let arr1=['10','10',"10","36","10"].map(parseInt);
// console.log(arr1);
// console.log(9);
...
//in operator is used to get key name in obj
...
//      for( let item in obj){
//          if(item =="title")
//             console.log(" yes item is present ");
//             return true
//      }
...
// converting arry  to object values 
// let arr=["a","b","c"];
// let obj1={...arr};
...
//  test(num,arr); //num value is passed to argument a ,arr is passed as refernce
                  //it can't change num vale only change reference values like arr obj
//  console.log(num);//100
...
// if we can give object props as array of elemnst to strongfy ,only those given properties will be sent to bakend as json data 
// let product={
//   name:"sony",
//   price:"100000",
//   ram:"4gb"
...
//  let result = JSON.stringify(product,["name","ram"]);
//  console.log(result);
...
// how to finde min number and max number in array usni gsingle line
...
// If you want to deeply freeze an object (including all nested objects), 
// you would need to create a custom function to recursively freeze all nested objects:
// let obj={
//   name:"laptop",
//   price:"900",
//   colo:"yellow",
...
// function deepfreez(parentobj){
//     Object.freeze(parentobj);
//     Object.keys(parentobj).forEach((nestedobjprop)=>{
//           if( typeof parentobj[nestedobjprop] === "object" && parentobj[nestedobjprop] !== null){
//             deepfreez(parentobj[nestedobjprop])
//           }
//     })
//  }
